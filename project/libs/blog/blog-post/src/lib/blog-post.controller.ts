...
import {CommentDto} from "@project/blog-comment";
...
export class BlogPostController {
  ...
  public async createComment(@Param('postId') postId: string, @Body() dto: CommentDto) {
    const newComment = await this.blogPostService.addComment(postId, dto);
    return fillDto(CommentDto, newComment.toPOJO());
  }
}
